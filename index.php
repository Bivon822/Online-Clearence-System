...
$dean_of_school = $rowaccess['is_dean_of_school_approved'];
$library = $rowaccess['is_library_approved'];
$dean_of_students = $rowaccess['is_dean_of_students_approved'];
$health_services = $rowaccess['is_health_services_approved'];
$chairperson_of_department = $rowaccess['is_chairperson_of_department_approved'];
$catering = $rowaccess['is_catering_approved'];
$ict = $rowaccess['is_ict_approved'];
...
<div class="col-lg-3">
					...
					<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                          ...
                          <div class="ibox-content">
							  ...
							  <?php if (($outstanding_fee)=="0" && ($sport)=="1" &&($hostel)=="1" && ($stud_affairs)=="1"  &&($dean_of_school)=="1"  &&($library)=="1"  &&($dean_of_students)=="1" &&($health_services)=="1" &&($chairperson_of_department)=="1" && ($catering)=="1" && ($ict)=="1")  { ?>
	                    ...
	                    <?php } ?> </h3>
								...
								<?php if (($outstanding_fee)=="0" && ($sport)=="1" &&($hostel)=="1" && ($stud_affairs)=="1" &&($dean_of_school)=="1" &&($library)=="1" &&($dean_of_students)=="1" &&($health_services)=="1" &&($chairperson_of_department)=="1" &&($catering)=="1" &&($ict)=="1")  { ?>
                                <span class="style2"><small> <a href="letter.php" target="_blank">Print Clearance Letter</a></small><br>
                                <a href="invite_letter.php" target="_blank">Graduation Notice</a></small>
                                </span>	
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-success pull-right">Outstanding fee</span></h5>
        ...
        <div class="row">
          <div class="col-lg-12"> 
            ...
            <p>		</p>
            <table width="900" height="341" align="center">
              <tr>
                <td width="1237"><table border="0" align="center" class="table table-hover no-margins">
                  <thead>
                    <tr>
                      <th width="1%"><div align="center" class="style1">Chairperson Of Department</div></th>
                      <th width="1%"><div align="center" class="style1">Dean Of School</div></th>
                      <th width="1%"><div align="center" class="style1">ICT</div></th>
                      <th width="1%"><div align="center" class="style1">Library</div></th>
					  <th width="1%"><div align="center"><span class="style1">Hostel</span></div></th>
                      <th width="1%"><div align="center" class="style1">Games & Sports</div></th>
                      <th width="1%"><div align="center" class="style1">Dean Of Students</div></th>
                      <th width="1%"><div align="center" class="style1">Catering</div></th>
                      <th width="1%"><div align="center" class="style1">Health Services Unit</div></th>
                      <th width="1%"><div align="center"><span class="style1">Finance </span></div></th>
					   <th width="1%"><div align="center" class="style1">Academic & Student Affairs</div></th>
                  ...
                  <tbody>
                   <tr>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_chairperson_of_department_approved'])==(("0")))  { ?>
					   ...
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
                        ...
                        <td>
					   	 <?php if (($rowaccess['is_dean_of_school_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                        ...
                        <td>
					   	 <?php if (($rowaccess['is_ict_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                     ...
                     <td>
					   	 <?php if (($rowaccess['is_dean_of_students_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                        ...
                        <td>
					   	 <?php if (($rowaccess['is_catering_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
                        ...
                        <td>
					   	 <?php if (($rowaccess['is_health_services_approved'])==(("0")))  { ?>
					   <div align="center"><span class="label label-warning">Pending</span> </div>
					   <?php } else {?>
					   <div align="center"><span class="label label-primary">Cleared</span> </div>
 						<?php } ?>
